export const SendIcon = () => {
    return (
        <svg
            ...
            className="iconSend icon-tabler icon-tabler-send"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            strokeWidth="2"
...
export const MicStartIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="iconMicro icon-tabler icon-tabler-microphone" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M9 2m0 3a3 3 0 0 1 3 -3h0a3 3 0 0 1 3 3v5a3 3 0 0 1 -3 3h0a3 3 0 0 1 -3 -3z" /><path d="M5 10a7 7 0 0 0 14 0" /><path d="M8 21l8 0" /><path d="M12 17l0 4" /></svg>
    )
}
export const MicStopIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="iconMicroStop icon-tabler icon-tabler-player-stop-filled" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M17 4h-10a3 3 0 0 0 -3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3 -3v-10a3 3 0 0 0 -3 -3z" stroke-width="0" fill="currentColor" /></svg>
    )
}
export const UploadIcon = () => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            className="iconUpload icon-tabler icon-tabler-upload"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            strokeWidth="2"
